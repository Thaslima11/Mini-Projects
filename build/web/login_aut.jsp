...
<html lang="en">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="single.jsp">SINGLE BLOG</a></li>
                        ...
                        <!--					<li class="dropdown">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                                <li><a href="contact.jsp">CONTACT</a></li>
                                                                                <li><a href="contact-alt.jsp">CONTACT WITH SIDEBAR</a></li>
                                                                        </ul>
                                                                </li>-->
    ...
    <!-- Mirrored from bootemplates.com/themes/kagum/login-alt.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Aug 2016 13:06:10 GMT -->
</html>