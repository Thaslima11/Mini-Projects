                                    ...
                                    <aside>
                                        ...
                                        <div class="content-footer">
                                            ...
                                            <span class="pull-right">
                                                <a href="login.jsp"><i class="fa fa-comments" data-toggle="tooltip" data-placement="top" title="Comments"></i> <%=rs.getString("bcomment")%></a>
                                                <a href="login.jsp"><i class="fa fa-heart" data-toggle="tooltip" data-placement="top" title="Loved"></i> <%=rs.getString("blike")%></a>
                                            </span>
                                        </div>
                                    </aside>
                                </div>
