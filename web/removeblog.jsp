                ...
                <div class="box-register">
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <label>Blog ID</label>
                            <input type="text" name="bid1" class="form-control" placeholder="Blog ID">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Blog ID</label>
                            <label type="text" name="bid1" class="form-control"><%=rs.getString("bid")%></label>
                        </div>
                        <div class="form-group">
                            <label>Title</label>
                        ...
                        <div class="form-group">
                            ...
                            <label type="text" name="fol1" class="form-control"><%=rs.getString("folder")%></label>
                        </div>
                    ...
                    <form action="Removeblog" method="post">
                        ...
                        <div class="form-group">
                            <button class="btn btn-warning btn-block">REMOVE BLOG</button>
                        </div>
                    ...
                    <%
                        ...
                        if (msg != null) {
                            ...
                            if (mg == 2) {
                    %><hr><div><h5> Blog Removed Successfully!!!</h5></div><%
                    } else {
                    %><hr><div><h5> Blog Removed Not Successfully!!!</h5></div><%
                            }
                        }
                    %>
                </div>
