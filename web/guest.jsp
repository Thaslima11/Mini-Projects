    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            function load(id1)
            {
                ...
                window.location.replace("guest.jsp?bid=" + name);
                < c:set var = "value" scope = "session" value = "${param['value']} " / >
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <aside>
                                        ...
                                        <div class="content-title">
                                            <div class="text-center">
                                                <h3><a href="blog1.jsp?bid=<%=rs.getString("bid")%>" ><%=rs.getString("title")%></a></h3>
                                            </div>
                                        </div>
                                        <div class="content-footer">
                                            ...
                                            <span class="pull-right">
                                                <a href="blog1.jsp?bid=<%=rs.getString("bid")%>"><i class="fa fa-comments" data-toggle="tooltip" data-placement="top" title="Comments"></i> <%=rs.getString("bcomment")%></a>
                                                <a href="Rate?bid=<%=rs.getString("bid")%>"><i class="fa fa-heart" data-toggle="tooltip" data-placement="top" title="Loved"></i> <%=rs.getString("blike")%></a>
                                            </span>
                                        </div>
                                    </aside>
                                </div>
